      ...
      <div class="list-box">
        <div class="util-box clearfix">
          <div class="inp-box clearfix">
            <span>地点：</span>
            <input style="width:300px" v-model="form.position" type="text" placeholder="请输入" class="inp" />
          </div>
        ...
        <div class="inner">
          ...
          >
            <el-form-item label="评分" prop="grade">
              <input-number class="asdfff" v-model="scoreForm.grade" placeholder="分值0-100" />
            </el-form-item>
