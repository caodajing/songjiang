                ...
                if(vm.initData.number > 10000){
                    ...
                    tool.getdata(apiPath.editeEquipmentDetail,'post',{
                        ...
                        if(data.status == 200){
                            ...
                            vm.editFlag = false;
                            tool.toast('保存成功');
                            vm.$router.replace({path:'/equipmentSet/detail',query:{storehouseId:vm.storehouseId,deptCode:vm.deptCode,equipmentTypeId:vm.equipmentTypeId,storehouseName:vm.storehouseName,type:vm.type,origin:vm.origin,truckLocation:vm.truckLocation}});
                        }
                    },true)
                }
            }
