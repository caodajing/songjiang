		    	...
		    	<div class="common-box" id="userInfo">
		    		...
		    		<div class="box clearfix">
						...
						<div class="inp-box flex">
							...
							<el-input v-model="detailUserInfo.permanentAddress" placeholder="请输入…" :disabled="!editFlag.userInfoFlag"></el-input>
						</div>
						<div class="inp-box flex">
							<span class="span">所属区县</span>
							<el-input v-model="detailUserInfo.districtsAndCounties" placeholder="请输入…" :disabled="!editFlag.userInfoFlag"></el-input>
						</div>
						<div class="inp-box flex">
							<span class="span">所属街道</span>
							<el-input v-model="detailUserInfo.subordinateStreets" placeholder="请输入…" :disabled="!editFlag.userInfoFlag"></el-input>
						</div>
						<div class="inp-box flex">
							<span class="span">家住区县</span>
							<el-input v-model="detailUserInfo.residentialDistrictsAndCounties" placeholder="请输入…" :disabled="!editFlag.userInfoFlag"></el-input>
						</div>
						<div class="inp-box flex">
						...
						<div class="inp-box flex">
							<span class="span">职技鉴初是否通过</span>
							<el-select  placeholder="请选择" v-model="detailUserInfo.vocationalSkills" :disabled="!editFlag.userInfoFlag">
							    <el-option
							      v-for="item in ZJJCList"
							      :key="item.value"
							      :label="item.label"
							      :value="item.value">
							    </el-option>
        ...
        methods:{
        	...
        	navSwitch(index,_id){
	            ...
	            if(index == 0){
	            	...
	            	window.scrollTo(0,1237);
	            }else if(index == 4){
	            	window.scrollTo(0,1965);
	            }else if(index == 5){
	            	window.scrollTo(0,1607);
	            }
